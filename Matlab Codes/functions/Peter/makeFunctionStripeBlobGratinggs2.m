% PTW 8/15/2012 hack for gs=2, modified from
...
OSC_AMP_FRAMES = 30; % 3 frames = 1 pixel (20px = 45 degrees)
CENTER_POS_OFFSET = 12; % center position is x = 13
MAX_POS = 24;
BLANK_POS_OFFSET = 64; % arbitrary, greater than 24...
...
fullOutFileNameX = [thisDirectoryName '\position_function_stripe_blob_grating_xgs2.mat'];
fullOutFileNameY = [thisDirectoryName '\position_function_stripe_blob_grating_ygs2.mat'];
func = funcx;
