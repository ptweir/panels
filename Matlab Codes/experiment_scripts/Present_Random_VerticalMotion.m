function Present_Random_VerticalMotion(Repeat,Duration1,Duration2,Duration4,Interval)
...
OutPutFile=strcat('Present_Random_VerticalMotion',datestr(TimeMatrix(1,:),'yyyymmddTHHMMSS'));
