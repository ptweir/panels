function Present_Stripe_Horizontal_Vertical2(Repeat,StripeDuration,HorizontalDuration,VerticalDuration)
...
OutPutFile=strcat('Present_Stripe_Horizontal_Vertical2',datestr(TimeMatrix(1,:),'yyyymmddTHHMMSS'));
