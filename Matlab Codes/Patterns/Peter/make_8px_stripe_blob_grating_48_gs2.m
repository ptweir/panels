% make_8px_stripe_blob_grating_48_gs2.m
% PTW 8/15/2012
...
PatsWithInvisibleColumn = maxGSValue*ones(32, 104, 104,2);
...
%% put all together
allPats = maxGSValue*ones(numVerticalPixels, numHorizontalPixels, 104, 3);
allPats(:,:,:,1:2) = PatsWithInvisibleColumn(:,1:96,:,:);
allPats(:,:,1:numTimes,3) = Pats;
...
str = [directory_name '\Pattern_8px_stripe_blob_grating_48_gs2'];
save(str, 'pattern');
